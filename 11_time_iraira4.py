...
someone = ['yashiro','kawamura','kawasaki','kobayashi','maeda','motoyama','tamaru','nomura','ota','shigenawa','suzuki','tabata','imahashi']
...
hight=1080
w=75
aoi_1=[width-(20+wide/3-w+area),hight-(20+w+area),width-(20+wide/3-w-area),hight-(20+w-area)]
aoi_2=[width-(20+wide/3-w+area),hight-(20+high/2-w+area),width-(20+wide/3-w-area),hight-(20+high/2-w-area)]
aoi_3=[width-(20+w+area),hight-(20+high/2+area),width-(20+w-area),hight-(20+high/2-area)]
aoi_4=[width-(20+w+area),hight-(20+high-w+area),width-(20+w-area),hight-(20+high-w-area)]
aoi_5=[width-(20+wide*2/3-w*2+area),hight-(20+high-w+area),width-(20+wide*2/3-w*2-area),hight-(20+high-w-area)]
aoi_6=[width-(20+wide*2/3-w*2+area),hight-(20+high/2+w+area),width-(20+wide*2/3-w*2-area),hight-(20+high/2+w-area)]
aoi_7=[width-(20+wide/3+w*2+area),hight-(20+high/2+area),width-(20+wide/3+w*2-area),hight-(20+high/2-area)]
aoi_8=[width-(20+wide/3+w*2+area),hight-(20+w+area),width-(20+wide/3+w*2-area),hight-(20+w-area)]
aoi_9=[width-(20+wide*2/3+area),hight-(20+w+area),width-(20+wide*2/3-area),hight-(20+w-area)]
aoi_10=[width-(20+wide*2/3+w+area),hight-(20+high/2+area),width-(20+wide*2/3+w-area),hight-(20+high/2-area)]
aoi_11=[width-(20+wide-w+area),hight-(20+high/2+w+area),width-(20+wide-w-area),hight-(20+high/2+w-area)]
aoi_12=[width-(20+wide-w+area),hight-(20+high-w+area),width-(20+wide-w-area),hight-(20+high-w-area)]
aoi_13=[width-(20+wide*2/3+w/2+area),hight-(high+40),width-(20+wide*2/3+w/2-area),hight-(40+high-2*area)]
...
someone = ['yashiro','kawamura','kawasaki','kobayashi','maeda','tamaru','watanabe','tamura','nomura','ota','shigenawa','suzuki','tabata','imahashi']
day=['02']
for sm in someone:
    for dy in day:
        for fn in file_name:
